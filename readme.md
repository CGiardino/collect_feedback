...
If you want to build something for real using meteor.js, preferable if you are a company or have funding.. you can always contact me [following me on twitter](https://twitter.com/carminegiardino).
